							...
							<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
								<tr>
									<TD vAlign="top" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid" width="200px">
										<DIV id="contentLeft">
											<TABLE cellSpacing="1" cellPadding="5" width="100%" height="100%" border="0">
												...
												<TR>
													<TD class="labelInfo"><asp:LinkButton id="lnkFWQX" Runat="server" Width="0px"></asp:LinkButton><A id="doFWQX" href="javascript:doFWQX()">访问权限</a></TD>
												</TR>
												<TR>
									...
									<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid" vAlign="top">							
										...
										<% response.write("</DIV>" + vbcr) %>	
										<% 
										    If propEditMode = 7 Then
										        Response.Write("<DIV id='contentRight7' style='display:'>" + vbCr)
										    Else
										        Response.Write("<DIV id='contentRight7' style='display:none'>" + vbCr)
										    End If
										%>	
										<TABLE cellSpacing="1" cellPadding="5" width="100%" border="0">
											<TR>
												<TD colspan="3"  class="typeTitle" align="left"  background="../../images/bg_title.gif" height="18px"><img src="../../images/titleicon.gif">&nbsp;权限范围</TD>
											</TR>
											<TR>
												<TD align="center">
													<TABLE  cellSpacing="0" cellPadding="0" border="0">
											            <TR vAlign="middle">
											                <TD class="labelNotNull" align="right" nowrap>能查看的区域：</TD>
						                                    <TD class="squre"  align="left"><asp:CheckBoxList id="cblRegion" Runat="server" CssClass="label" RepeatColumns="12" RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%"></asp:CheckBoxList></TD>
					                                    </TR>
											            <TR vAlign="middle">
											                <TD class="labelNotNull" align="right" nowrap>能查看的类型：</TD>
						                                    <TD class="squre"  align="left"><asp:CheckBoxList id="cblHouseType" Runat="server" CssClass="label" RepeatColumns="6" RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%"></asp:CheckBoxList></TD>
					                                    </TR>
					                                </TABLE>
					                            </TD> 
					                        </TR>
					                        <TR vAlign="middle">
												<td></td> 
												<TD align="left"><asp:button id="btnSaveQXFW" Runat="server" Width="80px" Height="36" CssClass="label" Text=" 修  改 "></asp:Button></TD>
												<td></td> 
											</TR> 
										</TABLE>
										<% response.write("</DIV>" + vbcr) %>						
